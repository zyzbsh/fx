...
public class WebViewInject {
    ...
    private static WebViewInject mInstance = null;
    
	public static WebViewInject getInstance() {
		if (mInstance == null) {
			 mInstance = new WebViewInject();
		}
		return mInstance;
	}
    
    public HashMap<String, Object> getmJsInterfaceMap() {
		return mJsInterfaceMap;
	}

	public void setmJsInterfaceMap(HashMap<String, Object> mJsInterfaceMap) {
		this.mJsInterfaceMap = mJsInterfaceMap;
	}

	public String getmJsStringCache() {
		return mJsStringCache;
	}

	public void setmJsStringCache(String mJsStringCache) {
		this.mJsStringCache = mJsStringCache;
	}

	public void injectJavascriptInterfaces(WebView webView) {
        if (!TextUtils.isEmpty(mJsStringCache)) {
            loadJavascriptInterfaces(webView);
            return;
        }
...
//    }
    ...
    private void loadJavascriptInterfaces(WebView webView) {
