...
public abstract class DatabaseColumn implements BaseColumns {
    ...
    public static final String[] SUBCLASSES = new String[]{"fxtrader.com.app.db.TicketsColumn", "fxtrader.com.app.db.UserCouponsColumn", "fxtrader.com.app.db.UserInfoColumn"};
