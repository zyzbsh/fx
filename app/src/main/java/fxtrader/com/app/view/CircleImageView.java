...
/**
 * 圆形图片 根据开源项目：https://github.com/hdodenhof/CircleImageView 更改
 * 
 * @author zyu
 * 
 */
public class CircleImageView extends ImageView {
	...
	private final RectF mInsideBorderRect = new RectF();
	...
	private int mInsideBorderColor = DEFAULT_BORDER_COLOR;
	private int mInsideBorderWidth = DEFAULT_BORDER_WIDTH;
	...
	public CircleImageView(Context context, AttributeSet attrs, int defStyle) {
		...
		mInsideBorderWidth = a.getDimensionPixelSize(
				R.styleable.CircleImageView_inside_border_width, DEFAULT_BORDER_WIDTH);
		mInsideBorderColor = a.getColor(R.styleable.CircleImageView_inside_border_color,
	...
	protected void onDraw(Canvas canvas) {
		...
		if (mInsideBorderWidth != 0) {
			canvas.drawCircle(getWidth() / 2, getHeight() / 2, mInsideBorderRadius,
					mInsideBorderPaint);
		}
	}
	...
	private void setup() {
		...
		mInsideBorderRect.set(0, 0, getWidth() - mBorderWidth * 2, getHeight() - mBorderWidth * 2);
		mInsideBorderRadius = Math.min((mInsideBorderRect.height() - mInsideBorderWidth) / 2,
				(mInsideBorderRect.width() - mInsideBorderWidth) / 2);
