...
import fxtrader.com.app.update.download.SqliteManager;
...
public class UpdateHelper {
    ...
    public void check(Update update, Activity activity) {
        UpdateAgent.getInstance().checkUpdate(update, activity);
    }
